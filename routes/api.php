...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'active'])->group(function () {
        ...
        // Tenant owner and manager
        Route::prefix('tenants')->group(function(){
            Route::get('{storeId?}', [StoreTenantController::class, 'getAllTenants'])->middleware('authorize:owner,manager');
            Route::put('{tenantId}/block', [StoreTenantController::class, 'blockTenant'])->middleware('authorize:owner');
            Route::put('{tenantId}/unblock', [StoreTenantController::class, 'unblockTenant'])->middleware('authorize:owner');
        });
    });
});
